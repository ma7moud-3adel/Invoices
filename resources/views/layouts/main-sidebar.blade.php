    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-morris')) }}">كل الفواتير</a></li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'cards')) }}">تقارير عن الفواتير</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'darggablecards')) }}">تقارير عن العملاء</a>
                    </li>
                </ul>
            </li>
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'form-advanced')) }}">صلاحيات المستخدمين</a>
                    </li>
                </ul>
            </li>
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'profile')) }}">قائمة المنتجات</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'editprofile')) }}">اضافة منتج</a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'invoice')) }}">تعديل منتج</a></li>
                </ul>
            </li>
        </ul>
    </div>
